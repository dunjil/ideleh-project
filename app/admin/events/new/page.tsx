...
export default function NewEventPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Upload image to Supabase Storage using our utility function
      const { path, error: uploadError } = await uploadToStorage(imageFile, "events")

      if (uploadError) throw uploadError

      // Insert event into database with image path
